...
function load_mailbox(mailbox) {
  ...
  .then(emails => {
    ...
    if (document.querySelector('#emails-view').querySelector('.svg-icon')) {
      document.querySelector('#emails-view').querySelector('.svg-icon').remove()
    }
